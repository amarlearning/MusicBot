<?php
	...
	if(preg_match($regex, $messageText) && $hello_flag == 0) {
    ...
    $url = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=". urlencode($messageText) . "&key=" . $youtube_api_key;
	$context = stream_context_create(array(
	  'http' => array(
		 'ignore_errors'=>true,
		 'method'=>'GET'
	...
	$video_id = $video_result_data['items'][$count]['id']['videoId'];
	$video_name = $video_result_data['items'][$count]['snippet']['title'];
